            ...
            <?php
                ...
                if(isset($_GET["begin"]))
                ...
                else
                    {
                     ...
                     $display=2;
                    $result=mysqli_query($conn , "SELECT * FROM `indexs` where cate_id=17  limit $position,$display");
        ...
        if($current!=1)
            {
                ...
                echo"<li class='page-item'>
                    <a class='page-link' href='gamehanhdong.php?id=1&begin=$prev' >Previous</a>
                     </li>";
            }
         for($page=1;$page<=$sum_page;$page++)
             {
                 ...
                 {
                    echo"<li class='page-item'>
                            <a class='page-link' href='gamehanhdong.php?id=1&begin=$begin' style='background-color:LightGray'>$page</a>
                        </li>";
                 }
                 else
                 {
                    echo"<li class='page-item'>
                    <a class='page-link' href='gamehanhdong.php?id=1&begin=$begin'>$page</a>
                     </li>";
                 }
            }
        if($current!=$sum_page)
            {
                ...
                echo"<li class='page-item'>
                <a class='page-link' href='gamehanhdong.php?id=1&begin=$next'>Next</a>
                 </li>"; 
            }
        echo"</ul>";
        }
