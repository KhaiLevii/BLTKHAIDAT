        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="row"  style="background:black;">
                    ...
                    <div class="col-md-6">
                        <h1 style="line-height: 250px; font-size:50px; text-shadow: 2px 2px 2px white; margin-left:30%;color:white;"> Sharing Games To You
                            </h1>
                    </div>
                </div>
                <div class="row">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                            <a class="dropdown-item" href="#">HÀNH ĐỘNG</a> <a class="dropdown-item"
                                                href="# ">PHIÊU LƯU<U></U></a> <a class="dropdown-item" href="#">THỂ THAO</a>
                                ...
                                <ul class="navbar-nav ml-md-auto">
                                    ...
                                    <li class="nav-item active">
                                        <a class="nav-link " href="register.php" id="navbarDropdownMenuLink">ĐĂNG KÝ</a>
